...
class KomodoMlipirAlgorithm:
    ...
    def __init__(self, n:int, p:float, d:float, fitness_function:callable , space_search:dict, max_iter:int, info_katogorikal_tipe:list, problem:str="maximize",random_state:int=22 ):
        self.n = n
        self.p = p
        self.d = d
